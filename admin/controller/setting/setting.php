...
class ControllerSettingSetting extends Controller
{
    ...
    public function index()
    {
        ...
        $data['entry_telephone_2'] = $this->language->get('entry_telephone_2');
        $data['entry_telephone_3'] = $this->language->get('entry_telephone_3');
        ...
        if (isset($this->error['telephone_3'])) {
            $data['error_telephone_3'] = $this->error['telephone_3'];
        } else {
            $data['error_telephone_3'] = '';
        }
    ...
    protected function validate()
    {
        ...
        if (
            (utf8_strlen($this->request->post['config_telephone_2']) < 9) ||
            (utf8_strlen($this->request->post['config_telephone_2']) > 32) ||
            (utf8_strlen(preg_replace('/[\D]/', '', $this->request->post['config_telephone_2']))) < 9 ||
            (utf8_strlen(preg_replace('/[\D]/', '', $this->request->post['config_telephone_2']))) > 32
        ) {
            $this->error['telephone_2'] = $this->language->get('error_telephone_2');
        }

        if (
            (utf8_strlen($this->request->post['config_telephone_3']) < 9) ||
            (utf8_strlen($this->request->post['config_telephone_3']) > 32) ||
            (utf8_strlen(preg_replace('/[\D]/', '', $this->request->post['config_telephone_3']))) < 9 ||
            (utf8_strlen(preg_replace('/[\D]/', '', $this->request->post['config_telephone_3']))) > 32
        ) {
            $this->error['telephone_3'] = $this->language->get('error_telephone_3');
        }
