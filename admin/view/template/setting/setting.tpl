                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-store">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-telephone_2"><?php echo $entry_telephone_2; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_telephone_2" value="<?php echo $config_telephone_2; ?>"
                                           placeholder="<?php echo $entry_telephone_2; ?>" id="input-telephone"
                                           class="form-control"/>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label"
                                       for="input-telephone_3"><?php echo $entry_telephone_3; ?></label>
                                <div class="col-sm-10">
                                    <input type="text" name="config_telephone_3" value="<?php echo $config_telephone_3; ?>"
                                           placeholder="<?php echo $entry_telephone_3; ?>" id="input-telephone"
                                           class="form-control"/>
                                    <?php if ($error_telephone_3) { ?>
                                        <div class="text-danger"><?php echo $error_telephone_3; ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-group">
