    ...
    <div class="tabs-content">
        <div class="good_content_item">
            <div class="good_item" data-discount="-30%">
                <a href="#" class="img"><img src="catalog/view/theme/logo/images/card_img1.png" alt=""></a>
        ...
        <div class="good_content_item">
            <div class="good_item">
                <a href="#" class="img"><img src="catalog/view/theme/logo/images/card_img2.png" alt=""></a>
                <div class="good_title">Smart Phone Primo V1</div>
                <div class="good_panel">
                    <div class="standard_panel">
                        <div class="good_price">
            ...
            <div class="good_item">
                <a href="#" class="img"><img src="catalog/view/theme/logo/images/card_img4.png" alt=""></a>
                <div class="good_title">Smart Phone Primo V1</div>
                <div class="good_panel">
                    <div class="standard_panel">
                        <div class="good_price">
    ...
    <div class="wrapper">
        <div class="action">
            <div class="action-pict">
                <img src="catalog/view/theme/logo/images/action-bkg.png" alt="">
            ...
            <div class="action-content">
                ...
                <p class="action-excerpt">Powered by a mighty 1.3 GHz Quad Core Processor and 1 GB fast RAM, the Primo
...
<section id="laptop" class="wrapper goods_tabs">
    <ul class="tabs">
        <li class='active good_tab_item'>Laptop</li>
    </ul>
    <div class="tabs-content">
        <div class="good_content_item">
            <div class="good_item" data-discount="-20%">
                <a href="#" class="img"><img src="catalog/view/theme/logo/images/card_img1.png" alt=""></a>
                <div class="good_title">Smart Phone Primo V1</div>
                <div class="good_panel">
                    <div class="standard_panel">
...
<section class="brands">
    <div class="wrapper">
        ...
        <div class="brand-logos">
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo1.png" alt="default"></a>
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo2.png" alt="default"></a>
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo3.png" alt="default"></a>
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo4.png" alt="default"></a>
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo5.png" alt="default"></a>
            <a href="#" class="logo animated"><img src="catalog/view/theme/logo/images/logo6.png" alt="default"></a>
        </div>
    </div>
</section>
<?= $content_bottom ?>
